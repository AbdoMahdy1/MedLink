        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CvFiles = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemServiceId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NurseServices_SystemServices_SystemServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NurseId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NurseServiceId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Orders_NurseServices_NurseServiceId",
                        column: x => x.NurseServiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NurseServices_NurseId_SystemServiceId",
                table: "NurseServices",
                columns: new[] { "NurseId", "SystemServiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NurseServices_SystemServiceId",
                table: "NurseServices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_NurseServiceId",
                table: "Orders",
                column: "NurseServiceId");
